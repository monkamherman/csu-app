      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Chaque service transformé en solution productisée. Choisissez vos modules, nous livrons en 7 jours maximum.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {modules.map((module, index) => (
            ...
            >
              ...
              <div className="text-blue-400 mb-4 group-hover:text-blue-300 transition">{module.icon}</div>
              ...
              <Link
                ...
                className={`w-full py-3 rounded-lg font-bold text-center transition ${
                  module.popular ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-700 hover:bg-gray-600'
                }`}
              >
                Activer ce Module
              </Link>
