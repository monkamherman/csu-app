      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-8">
            ...
            <p className="text-4xl font-bold mb-6">$997<span className="text-lg text-gray-400">/mois</span></p>
            ...
            <Link href="/dashboard" className="w-full py-3 bg-gray-700 hover:bg-gray-600 rounded-lg font-bold text-center transition block">
              Choisir Starter
            </Link>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-900/50 to-purple-900/50 border border-blue-500 rounded-xl p-8 relative">
            ...
            <p className="text-4xl font-bold mb-6">$2,497<span className="text-lg text-gray-400">/mois</span></p>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2 text-gray-300">
                <CheckCircle className="w-5 h-5 text-green-500" />
                3 modules au choix
            ...
            <Link href="/dashboard" className="w-full py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-bold text-center transition block">
              Choisir Growth
            </Link>
          </div>
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-8">
            ...
            <p className="text-4xl font-bold mb-6">$5,997<span className="text-lg text-gray-400">/mois</span></p>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2 text-gray-300">
                <CheckCircle className="w-5 h-5 text-green-500" />
                Tous les modules
